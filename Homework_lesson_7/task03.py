...
class Cell:
    ...
    def __sub__(self, other):
        if self.number - other.number > 0:
            ...
            return "Невозможно выполнить операцию. Разность меньше нуля."
    ...
    def make_order(self, num: int):
        x = self.number // num  # получаем количество полных рядов
        y = self.number % num  # получаем остаток
        z = ''  # пустая стартовая строка
